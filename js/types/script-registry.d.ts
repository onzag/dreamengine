...
declare type FSSBase = { description: DEStringTemplateCharAndOther; relationshipName: DEStringTemplateCharAndOther | null; bondAdditionalDescription?: DEStringTemplateCharAndOther | undefined; generalCharacterDescriptionInjection?: DEStringTemplateCharAndOther | undefined; generalCharacterDescriptionInjectionEx?: DEStringTemplateCharAndOther | undefined; openToAffection: (DE: DEObject, char: DECompleteCharacterReference, other: DECompleteCharacterReference) => Promise<{ value: boolean | string; reason?: string; }>; openToIntimateAffection: (DE: DEObject, char: DECompleteCharacterReference, other: DECompleteCharacterReference) => Promise<{ value: boolean | string; reason?: string; }>; openToSex: (DE: DEObject, char: DECompleteCharacterReference, other: DECompleteCharacterReference) => Promise<{ value: boolean | string; reason?: string; }>; proneToInitiatingAffection: (DE: DEObject, char: DECompleteCharacterReference, other: DECompleteCharacterReference) => Promise<{ probability: number; options?: string[]; }>; proneToInitiatingIntimateAffection: (DE: DEObject, char: DECompleteCharacterReference, other: DECompleteCharacterReference) => Promise<{ probability: number; options?: string[]; }>; proneToInitiatingSex: (DE: DEObject, char: DECompleteCharacterReference, other: DECompleteCharacterReference) => Promise<{ probability: number; options?: string[]; }>; };
