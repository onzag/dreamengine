...
export class WorldWizard extends CardTypeWizard {
    ...
    async initializeWorldWizard() {
        ...
        const isCardType = isCardTypeFile(worldSource.src);
        ...
        if (!isCardType) {
            ...
            const parsedCard = createCardStructureFrom(worldSource.src);
            const isCompleteCard = parsedCard.config.guidedWizardCompleted;
            if (isCompleteCard) {
                const contentArea = this.root.querySelector('.wizard-content');
                // @ts-ignore
