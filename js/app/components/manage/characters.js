...
class AppManageCharacters extends HTMLElement {
    ...
    async reloadCharacterNamespaces() {
        ...
        if (allNamespaces.length === 0) {
            ...
            const namespaceElements = allNamespaces.map(namespace => `
                <div class="character-group-item" role="button" tabindex="0" data-de-aria-key="e" data-de-aria-horizontal-alignment="end-outside" data-character-group="${namespace}">
                    <div class="character-group-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" role="img" aria-label="${namespaceDisplayer(namespace)}">
    ...
    render() {
        ...
        this.root.innerHTML = `
            ...
            ${hasNewButton ? '<app-overlay-button play-sound-on-click="false" aria-key="n">New Character</app-overlay-button>' : ''}
            <div class="characters-container">
                <h2 tabindex="0" data-de-aria-text="true" role="navigation"><span>Characters</span>&nbsp;<span class="namespace-name"></span></h2>
