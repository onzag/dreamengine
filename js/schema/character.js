...
const schema = {
    ...
    "properties": {
        ...
        "general": {
            ...
            "description": "Describes the character general behaviour and personality, written in 3rd person, use {{char}} to refer to the character name",
            "maxLength": 1000,
            "minLength": 50,
            "placeholder": "{{char}} is a brave and adventurous explorer, always seeking new challenges and experiences.\n\n{{char}} has a strong sense of justice and is willing to help those in need",
            "placeholder_ts": "return `${char.name} is a brave and adventurous explorer, always seeking new challenges and experiences.\n\n${char.name} has a strong sense of justice and is willing to help those in need.`;",
            "multiline": true,
